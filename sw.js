...
// v45: مصحف بحجمه المطبوع (لا تصغير تلقائي) + المنزلق الافتراضي ١٠٠ + اصلاح
//      قطع أيقونة التبويب النشط من الأعلى (حذف overflow:hidden وborder-radius)
//      + محو الثوابت المتراكمة في التعليقات الفاسدة من تعديل بالبايثون
...
const CACHE_NAME = 'quran-app-v45';
const API_CACHE = 'quran-api-v45';
const STATIC_CACHE = 'static-v45';
